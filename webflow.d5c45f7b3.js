        ...
        var D = e.frame = function() {
          ...
          , W = l(function(t) {
            ...
            t.init = function(t, e, n, i) {
                ...
                this.string = this.name + A + this.duration + "ms" + ("ease" != this.ease ? A + d[this.ease][0] : "") + (this.delay ? A + this.delay + "ms" : ""))
            }
            ,
            t.set = function(t) {
            ...
            return function(r, a) {
                ...
                if (s && "setting" === r.type) {
                    ...
                    if ("swipe" === r.type) {
                        ...
                        if (i.env("editor"))
                            return;
                        return "left" === a.direction ? C(n)() : "right" === a.direction ? T(n)() : void 0
                    }
